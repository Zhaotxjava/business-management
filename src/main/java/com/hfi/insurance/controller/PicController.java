...
//        PicPathRes picPathRes = JSONObject.toJavaObject(JSONObject.toJSON(picPath),PicPathRes.class);
        String fileKey = request.getHeader("fileKey");
